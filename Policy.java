...
public class Policy { // - Use the following guidelines to create the Policy class:
    ...
    public Policy() { // - Include a no-arg constructor (set default values for all fields)
        this.policyNumber = 0;
        this.providerName = "";
